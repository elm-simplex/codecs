...
encodeOrder order =
    case order of
        LT ->
            encodeSequenceWithoutLength [ encodeString "LT" ]

        EQ ->
            encodeSequenceWithoutLength [ encodeString "EQ" ]

        GT ->
            encodeSequenceWithoutLength [ encodeString "GT" ]
